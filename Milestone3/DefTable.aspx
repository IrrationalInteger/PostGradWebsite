<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefTable.aspx.cs" Inherits="Milestone3.DefTable" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height: 747px; margin-left: 0px; background-color:#d8f4f5; margin-right: 0px; margin-top: 0px;">
            ...
            <asp:GridView ID="GridView1" runat="server" Height="246px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin-left: 344px; margin-top: 192px" Width="825px">
            </asp:GridView>
