<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Publications.aspx.cs" Inherits="Milestone3.Publications" %>
...
<body style="height: 1533px; background-color:#d8f4f5">
    <form id="form1" runat="server">
        ...
        <div id="div1" style="z-index: 1; left: 10px; top: 370px; position: absolute; height: 1177px; width: 1393px" runat="server">
            <asp:Table ID="Table1" runat="server" BackColor="White" BorderColor="#1CE36B" BorderStyle="Ridge" BorderWidth="10px" EnableTheming="True" GridLines="Both" style="z-index: 1; left: 0px; top: 0px; position: absolute; height: 71px; width: 1080px">
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell runat="server" BorderColor="#1CE36B" BorderStyle="Ridge" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="Larger" HorizontalAlign="Center">Publication ID</asp:TableCell>
                    <asp:TableCell runat="server" BorderColor="#1CE36B" BorderStyle="Ridge" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="Larger" HorizontalAlign="Center">Publication Title</asp:TableCell>
                    ...
                    <asp:TableCell runat="server" BorderColor="#1CE36B" BorderStyle="Ridge" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="Larger">Place</asp:TableCell>
                    <asp:TableCell runat="server" BorderColor="#1CE36B" BorderStyle="Ridge" BorderWidth="10px" Font-Bold="True" Font-Names="Calibri" Font-Size="Larger">Host</asp:TableCell>
